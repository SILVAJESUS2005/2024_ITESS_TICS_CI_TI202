...
public class GestorCuenta {
    ...
    public static void operarCuenta(CuentaBancaria cuenta, CuentaBancaria otraCuenta) {
        ...
        // Realizar operaciones adicionales (depósito, retiro, consulta de saldo, transferencia, etc.)
        int opcionOperacion;
        do {
            opcionOperacion = Integer.parseInt(JOptionPane.showInputDialog("Seleccione una opción:\n"
                    + "1. Realizar depósito\n"
                    + "2. Realizar retiro\n"
                    + "3. Consultar saldo\n"
                    + "4. Transferir fondos\n"
